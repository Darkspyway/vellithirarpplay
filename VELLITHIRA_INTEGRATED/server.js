    ...
    try {
        ...
        if (action === 'accept') {
            ...
            await sendLog(MOD_LOG_CHANNEL, {
                ...
                description: `**Staff:** ${staffName}\n**Applicant:** ${member ? member.user.tag : targetId}\n**Status:** Visa Role Assigned (DM Sent)`,
                color: 0x00ff99,
                timestamp: new Date()
            });
            ...
            await sendLog(MOD_LOG_CHANNEL, {
                ...
                description: `**Staff:** ${staffName}\n**Applicant:** ${member ? member.user.tag : targetId}\n**Status:** Application Denied (DM Sent)`,
                color: 0xff4757,
                timestamp: new Date()
            });
        }
...
function formatAnswers(answers) {
    if (!answers || !Array.isArray(answers)) return 'No answers provided.';
